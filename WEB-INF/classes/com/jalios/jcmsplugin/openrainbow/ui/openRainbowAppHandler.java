...
public class openRainbowAppHandler extends QueryHandler {
	...
	public String getRainbowAuthURI() {
		 ...
		 */
		String rainbowAuthURI = RAINBOWHOST + "response_type=token" + "&client_id=" + appID + "&redirect_uri="
				+ oAuthRedirect + "&scope=all";
	...
	public static void setInvitationCount(int count) {
	...
	public static int getCurrentInvitationsCount() {
